...
from aiogram.types import CallbackQuery, InlineQuery, Message, ChatJoinRequest
...
class UsersMiddleware(BaseMiddleware):
    ...
    # @staticmethod
    # async def on_process_chat_join_request(chat_member: ChatJoinRequest, data: dict[str]):
